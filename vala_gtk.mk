...
#
# Use VALA_GTK_CSOURCES in your project target C sources instead of VALA_CSOURCES,
# to ensure you have created resources .c and .h files first, before to build
# your project.
#
...
VALAFLAGS+= \
	...
	$(srcdir)/resources.vapi \
	$(NULL)

vala_resources.c: $(VALA_GTK_RESOURCES)
	$(GLIB_COMPILE_RESOURCES) --sourcedir=$(srcdir) --generate-source --target vala_resources.c --internal $^ \
	&& $(GLIB_COMPILE_RESOURCES) --sourcedir=$(srcdir) --generate --target vala_resources.h --internal $^
